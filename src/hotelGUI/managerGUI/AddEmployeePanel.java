...
public class AddEmployeePanel extends javax.swing.JPanel {
    ...
    private void addButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addButtonActionPerformed
        ...
        newEmp.setfirstname(firstNameText.getText());
        newEmp.setlastname(lastNameText.getText());
        newEmp.setemail(emailText.getText());
        newEmp.setpassword(randomPassword());
        newEmp.setadress(adressText.getText());
        newEmp.setphone(phoneText.getText());
        newEmp.setSSN(ssnText.getText());
        employeeController newEmpCtrl = new employeeController(newEmp);
        addEmployee(newEmpCtrl);
